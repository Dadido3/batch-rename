...
func main() {
	...
	toCopy := []string{
		"batch-rename.exe", // TODO: Find a better solution that is independent of the OS

		"LICENSE", "README.md",

		//filepath.Join("screenshots"),
	}
	...
	for _, v := range toCopy {
		srcPath, archivePath := filepath.Join(".", v), filepath.Join(v)
